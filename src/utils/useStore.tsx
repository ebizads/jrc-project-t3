...
type DieselGenStart = {
    genStart: boolean | null | undefined
    setGenStart: (genStartFloat : boolean) => void
}

export const useDieselGenStart = create<DieselGenStart>((set) => ({
    genStart: null,
    setGenStart: (genStartFloat: boolean) => set({ genStart: genStartFloat }),
}))
